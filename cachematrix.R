...
## This function creates a matrix object tha can cache its inverse
...
makeCacheMatrix <- function(x = matrix()) {inv <- NULL                             
    ...
    list(set = set, get = get, setinverse = setinverse, getinverse = getinverse)  ## you need this list in order to refer 
...
## then cacheSolve will retrieve the result from the cache
